...
RUN python3 -m pip install --no-cache-dir pandas seaborn sklearn graphviz xgboost lightgbm imblearn pydot opencv-python tqdm imageio scikit-image statsmodels
